			...
			for i in range(bossNum):
				if bossTimeString[i] == '99:99:99' and bossMungFlag[i] != True :
					...
					if bossMungFlag[i] == True :
						...
						aa.append(bossTime[i])                           #output_bossData[1] : 시간 asine
						aa.append(bossTime[i].strftime('%H:%M:%S')-datetime.timedelta(days=1))      #output_bossData[2] : 시간(00:00:00) -> 초빼기 : aa.append(bossTime[i].strftime('%H:%M'))  
						aa.append('+')	                                 #output_bossData[3] : +
